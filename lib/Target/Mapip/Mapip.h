...
namespace llvm {
  ...
  FunctionPass *createMapipDelaySlotFillerPass(TargetMachine &TM);
  FunctionPass *createMapipFPMoverPass(TargetMachine &TM);

} // end namespace llvm;

namespace llvm {
  // Enums corresponding to Mapip condition codes, both icc's and fcc's.  These
